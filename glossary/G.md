...
A serializer-deserializer chip receiving and transmitting serial data at 4.8 Gb/s, which uses the GBT protocol.
See [The GBT project](https://cds.cern.ch/record/1235836/files/p342) document.
